...
class TestCase(unittest.TestCase):
    ...
    def test_helper_asdict_namedtuple(self):
        ...
        # Now with a dict_factory.  OrderedDict is convenient, but since it
        # compares to dicts, we also need to have separate assertIs tests.
        d = asdict(c, dict_factory=OrderedDict)
        self.assertEqual(
            d, {"x": "outer", "y": T(1, {"x": "inner", "y": T(11, 12, 13)}, 2),}
        )
    ...
    def test_helper_asdict_namedtuple_key(self):
        # Ensure that a field that contains a dict which has a namedtuple as a
        # key works with asdict().
